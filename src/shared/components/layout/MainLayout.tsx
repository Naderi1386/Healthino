...
export const MainLayout: React.FC = () => {
  ...
  return (
    <div className="relative min-h-screen overflow-x-hidden">
      {/* Main Layout Wrapper - Blurred and disabled if not onboarded */}
      <div
        className={`min-h-screen bg-background flex flex-col lg:grid lg:grid-cols-[30%_70%] transition-all duration-700 ease-in-out ${
          !isOnboarded ? 'blur-md pointer-events-none select-none filter' : ''
        }`}
      >
